  ...
  const icons = new Map()
    .set(
      ...
      <svg
        ...
        data-prefix="fab"
        data-icon="github"
        className="svg-inline--fa fa-github fa-w-16 icon"
        role="img"
    ...
    .set(
      ...
      <svg
        ...
        className="svg-inline--fa fa-linkedin-in fa-w-14 icon"
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 448 512"
        style={{
    ...
    .set(
      ...
      <svg
        ...
        data-prefix="fab"
        data-icon="html5"
        className="svg-inline--fa fa-html5 fa-w-12 icon"
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 384 512"
        style={{
    ...
    .set(
      ...
      <svg
        ...
        data-prefix="fab"
        data-icon="css3-alt"
        className="svg-inline--fa fa-css3-alt fa-w-12 icon"
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 384 512"
        style={{
    ...
    .set(
      ...
      <svg
        ...
        data-prefix="fab"
        data-icon="aws"
        className="svg-inline--fa fa-aws fa-w-20 icon"
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 640 512"
        style={{
    ...
    .set(
      ...
      <svg
        ...
        data-prefix="fab"
        data-icon="react"
        className="svg-inline--fa fa-react fa-w-16 icon"
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
        style={{
    ...
    .set(
      ...
      <svg
        ...
        data-prefix="fab"
        data-icon="js-square"
        className="svg-inline--fa fa-js-square fa-w-14 icon"
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 448 512"
        style={{
    ...
    .set(
      ...
      <svg
        ...
        data-prefix="fab"
        data-icon="angular"
        className="svg-inline--fa fa-angular fa-w-14 icon"
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 448 512"
        style={{
    ...
    .set(
      ...
      <svg
        ...
        data-prefix="fas"
        data-icon="envelope"
        className="svg-inline--fa fa-envelope fa-w-16 icon"
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 512 512"
        style={{
    ...
    .set(
      ...
      <svg
        ...
        data-prefix="fas"
        data-icon="bars"
        className="svg-inline--fa fa-bars fa-w-14 icon"
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 448 512"
        style={{
    ...
    .set(
      ...
      <svg
        ...
        data-prefix="fas"
        data-icon="times"
        className="svg-inline--fa fa-times fa-w-11 icon"
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 352 512"
        style={{
    ...
    .set(
      ...
      <svg
        ...
        data-prefix="fab"
        data-icon="sass"
        className="svg-inline--fa fa-sass fa-w-20 icon"
        role="img"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 640 512"
        style={{
